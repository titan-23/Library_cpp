...
if __name__ == '__main__':
  ...
  banned_dirs = {'./titan_cpplib/data_structures/_arcive', './titan_cpplib/others/machine'}
  ...
  for cur_dir, dirs, files in os.walk('./titan_cpplib/'):
    for file in files:
      ...
      output_dir = "./_docs/_build/_expanded/" + output_dir[len("./titan_cpplib/"):]
      output_path = "./_docs/_build/_expanded/" + input_path[len("./titan_cpplib/"):]
      ...
      command = ["pypy3", "./titan_cpplib/expander.py", output_path, output_path]
      try:

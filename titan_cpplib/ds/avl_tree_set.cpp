/// https://github.com/titan-23/Library_cpp/blob/main/titan_cpplib/ds/avl_tree_set.cpp
#pragma once
...
#include <cassert>
#include <stack>
#include "titan_cpplib/ds/bbst_node.cpp"
using namespace std;
...
private:
    ...
    AVLTreeSet(const vector<T> &a, T missing) : missing(missing) {
        this->root = build(a);
    }

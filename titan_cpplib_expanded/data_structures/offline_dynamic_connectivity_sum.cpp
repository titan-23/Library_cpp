// #include "titan_cpplib/data_structures/offline_dynamic_connectivity_sum.cpp"
#include <vector>
#include <stack>
#include <algorithm>
#include <cassert>
...
// #include "titan_cpplib/data_structures/undoable_union_find_sum.cpp"
#include <vector>
using namespace std;
...
namespace titan23 {
  ...
  class OfflineDynamicConnectivitySum {
   ...
   public:
    UndoableUnionFindSum uf;

    OfflineDynamicConnectivitySum(const int n, const int q, const T e) :
        _n(n),
        _query_count(0),
